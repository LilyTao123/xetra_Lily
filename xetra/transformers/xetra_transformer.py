...
class XetraSourceConfig(NamedTuple):
    ...
    src_col_max_price: column name for manimum price in source
...
class XetraTargetConfig(NamedTuple):
    ...
    trg_col_max_price: column name for manimum price in target 
...
class XetraETL():
    ...
    def __init__(self, s3_bucket_src: S3BucketConnector,
        ...
        :params s3_bucket_src: connection to source S3 bucket
        :params s3_bucket_trg: connection to target S3 bucket
    ...
    def extract(self):
        ...
        if not files:
            ...
            date_frame = pd.concat([self.s3_bucket_src.read_csv_to_df(file)\
    ...
    def transform_report1(self, data_frame:pd.DataFrame):
        ...
        # Calculating closing price per ISIN and key
