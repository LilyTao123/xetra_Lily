...
class TestMetaProcessMethods(unittest.TestCase):
    ...
    def test_update_meta_file_no_meta_file(self):
        ...
        where there is no meta file
        '''
        # Excepted results
        date_list_exp = ['2022-06-26','2022-06-26']
        ...
        df_meta_result = StringIO(data)
        df_meta_result = pd.read_csv(df_meta_result)
    ...
    def test_update_meta_file_meta_file_ok(self):
        ...
        date_list_new = ['2022-05-14','2022-05-17']
    ...
    def test_update_meta_file_meta_file_wrong(self):
        ...
        # Expected results
        date_list_old = ['2022-05-12','2022-05-13']
        date_list_new = ['2022-05-16','2022-05-17']
        # Test init
        meta_key = 'meta.csv'
        meta_content = (
            f'wrong column,{MetaProcessFormat.META_PROCESS_COL.value}\n'
            f'{date_list_old[0]},'
            f'{datetime.today().strftime(MetaProcessFormat.META_PROCESS_DATE_FORMAT.value)}\n'
            f'{date_list_old[1]},'
            f'{datetime.today().strftime(MetaProcessFormat.META_PROCESS_DATE_FORMAT.value)}'
    ...
    def test_return_date_list_no_meta_file(self):
        ...
        meta_key = 'meta.csv'
        # Method execution
        min_date_return, date_list_return = MetaProcess.return_date_file(
    ...
    def test_return_date_list_meta_file_ok(self):
        ...
        for count, first_date in enumerate(first_date_list):
            min_date_return, date_list_return = MetaProcess.return_date_file(first_date,meta_key,
                                                                            self.s3_bucket_meta)
            # Test after method execution
    ...
    def test_return_date_list_meta_file_wrong(self):
        ...
        with self.assertRaises(KeyError):
            MetaProcess.return_date_file(first_date, meta_key, self.s3_bucket_meta)
        # Cleanup after test
        self.s3_bucket.delete_objects(
            Delete = {
                'Objects':[
